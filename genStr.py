...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/virtual_executive'),
                InlineKeyboardButton('Developer', url='https://t.me/Azure_id')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/Nakama_asl'),
            ]
        ]
    )
